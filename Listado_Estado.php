	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=listado_mecanicos"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							...
							switch ($row['status']) {
								case '1':
									echo "<span class='badge badge-pill badge-info'> Ingreso al taller</span>";
									break;
								case '2':
								...
								case '5':
									...
									break;
								case '':
										echo "<span class='badge badge-pill badge-primary'> recogido</span>";
										break;
...
<script>
	...
	_conf("Esta seguro que quiere eliminar dato?","delete_parcel",[$(this).attr('data-id')])
	})
	})
