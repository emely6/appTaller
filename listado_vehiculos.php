	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=registro_vehiculos"><i class="fa fa-plus"></i> Agregar Nuevo</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<thead>
					<tr>
						...
						<th>id</th>
						<th>Marca Vehiculo/Placa/Color.</th>
				...
				<tbody>
					...
					<tr>
						...
						<td><b><?php echo ucwords($row['city'].', '.$row['state']) ?></b></td>
