	...
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Encargado de</label>
                <select name="branch_id" id="" class="form-control input-sm select2">
                  <option value=""></option>
                  <?php
                    $branches = $conn->query("SELECT *,concat(street,', ',city,', ',state,', ',country) as address FROM branches");
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <?php if(isset($id)): ?>
                  <small class=""><i>Deje esto en blanco si no desea cambiar esto</i></small>
                <?php endif; ?>
              </div>
            </div>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			...
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./index.php?page=listado_mecanicos">Cancel</a>
  		</div>
  	</div>
	</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
              location.href = 'index.php?page=listado_mecanicos'
					},2000)
				}else if(resp == 2){
