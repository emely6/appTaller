	...
	<div class="card card-outline card-primary">
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Marca Vehiculo/Placa/Color Vehiculo</label>
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Detalle Reparacion</label>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-branch">Guardar</button>
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./index.php?page=branch_list">Cancelar</a>
  		</div>
  	</div>
	</div>
</div>
